...
* **Unified Foundation Models**
  * ***Large-scale Training:*** [PAN: World Model](https://ifm.mbzuai.ac.ae/pan/), [YuLan-Chat: LLM](https://github.com/RUC-GSAI/YuLan-Chat)
  * ***Reliable Evaluation:*** [Decentralized LLM-as-Judge](https://de-arena.maitrix.org/)
  * ***Review:*** [LLM Survey](https://arxiv.org/abs/2303.18223) 7000 Citations!
...
* [**PAN**](https://ifm.mbzuai.ac.ae/pan/)
...
* Six Highly-cited Papers are selected as the most influential KDD/WWW/CIKM papers by PaperDigest:
  ...
  * [EMNLP](https://www.paperdigest.org/2025/11/emnlp-2025-papers-highlights/): [POPE](https://arxiv.org/pdf/2305.10355)
